...
```
The maximum does appear in the plot to be where both $\alpha$s are between 0 and 2, and the maximum is near $(1.1,0.9)$, so our root appears correct!
