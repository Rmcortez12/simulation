...
results
```
Bartlett's test appears superior when the data is in fact Normal; the significance levels for Levene's test are a bit higher than they should be ideally.  However, for the other two distributions, Bartlett's test is a disaster; it's non-robustness is borne out.  Levene's test is not terrible for the Scaled t$_3$ distribution.  It is not good for Exponential, but it is far superior to Bartlett's.
